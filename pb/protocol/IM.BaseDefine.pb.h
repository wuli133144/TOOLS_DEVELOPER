...
const ServiceID ServiceID_MAX = SID_RPC;
...
const LoginCmdID LoginCmdID_MAX = CID_LOGIN_RES_SYSTEMLOGIN;
...
const MessageCmdID MessageCmdID_MAX = CID_MSG_FROM_SYSTEM_2APP;
...
enum GroupCmdID {
  ...
  CID_GROUP_MANAGER_CREATE_REQUEST = 1104,
  CID_GROUP_MANAGER_CREATE_RESPONSE = 1105
};
bool GroupCmdID_IsValid(int value);
const GroupCmdID GroupCmdID_MIN = CID_GROUP_NORMAL_LIST_REQUEST;
const GroupCmdID GroupCmdID_MAX = CID_GROUP_MANAGER_CREATE_RESPONSE;
...
const OtherCmdID OtherCmdID_MAX = CID_OTHER_RPC_MSG_GROUP_DATA;
...
enum ConsultCmdID {
  ...
  CID_CONSULT_ROBOT_STATUS_NOTIFY = 2096,
  CID_CONSULT_ROBOT_TRANSFER_TEACHER_NOTIFY = 2097,
  CID_SERVER_SYSTEMLOGIN_STATUS_NOTIFY = 2098
};
bool ConsultCmdID_IsValid(int value);
const ConsultCmdID ConsultCmdID_MIN = CID_CONSULT_DATA;
const ConsultCmdID ConsultCmdID_MAX = CID_SERVER_SYSTEMLOGIN_STATUS_NOTIFY;
...
const RPCCmdID RPCCmdID_MAX = CID_RPC_DELETE_GROUP_MSG_RESPONSE;
...
enum ClientType {
  ...
  CLIENT_TYPE_WECHAT = 33
};
bool ClientType_IsValid(int value);
const ClientType ClientType_MIN = CLIENT_TYPE_WINDOWS;
const ClientType ClientType_MAX = CLIENT_TYPE_WECHAT;
...
enum RobotStatus {
  ROBOT_STATUS_NORMAL = 1,
  ROBOT_STATUS_ABNORMAL = 2
};
bool RobotStatus_IsValid(int value);
const RobotStatus RobotStatus_MIN = ROBOT_STATUS_NORMAL;
const RobotStatus RobotStatus_MAX = ROBOT_STATUS_ABNORMAL;
const int RobotStatus_ARRAYSIZE = RobotStatus_MAX + 1;

enum SystemLoginStatus {
  SYSTEM_LOGIN_STATUS_NONE = 0,
  SYSTEM_LOGIN_STATUS_YES = 1
};
bool SystemLoginStatus_IsValid(int value);
const SystemLoginStatus SystemLoginStatus_MIN = SYSTEM_LOGIN_STATUS_NONE;
const SystemLoginStatus SystemLoginStatus_MAX = SYSTEM_LOGIN_STATUS_YES;
const int SystemLoginStatus_ARRAYSIZE = SystemLoginStatus_MAX + 1;
...
enum ConsultCreateType {
  ...
  CONSULT_CREATE_TYPE_STUDENT_TO_ROBOT = 96,
  CONSULT_CREATE_TYPE_ROBOT_TO_ONLINE_MANAGER = 97,
  CONSULT_CREATE_TYPE_ROBOT_TO_ONLINE_DUTY = 98,
  CONSULT_CREATE_TYPE_ROBOT_TO_LEAVE_MSG_TO_MANAGER = 99,
  CONSULT_CREATE_TYPE_ROBOT_TO_LEAVE_MSG_TO_DUTY = 100,
  CONSULT_CREATE_TYPE_ROBOT_TO_MANAGER_OUT_QUEUE = 101,
  CONSULT_CREATE_TYPE_ROBOT_TO_DUTY_OUT_QUEUE = 102,
  CONSULT_CREATE_TYPE_ROBOT_TO_TEACHER_CANCEL_QUEUE = 103
};
...
const ConsultCreateType ConsultCreateType_MAX = CONSULT_CREATE_TYPE_ROBOT_TO_TEACHER_CANCEL_QUEUE;
...
enum ConsultCloseType {
  ...
  CONSULT_CLOSE_TYPE_ROBOT_NO_ANSWER = 33,
  CONSULT_CLOSE_TYPE_ROBOT_TO_TEACHER_CANCEL_QUEUE_IM_CLOSE = 34,
...
enum ConsultScriptType {
  ...
  CONSULT_SCRIPT_TYPE_ROBOT_NO_ANSWER_TO_APP = 17
};
...
const ConsultScriptType ConsultScriptType_MAX = CONSULT_SCRIPT_TYPE_ROBOT_NO_ANSWER_TO_APP;
...
const MQTopicType MQTopicType_MAX = TEACHER_SEND_HOMEWORK_URL;
...
const RobotType RobotType_MIN = ROBOT_TYPE_NOT;
const RobotType RobotType_MAX = ROBOT_TYPE_A;
const int RobotType_ARRAYSIZE = RobotType_MAX + 1;
...
class StudentStat : public ::google::protobuf::MessageLite {
 public:
  ...
  // optional uint32 consult_teacher_identity = 8;
  inline bool has_consult_teacher_identity() const;
  inline void clear_consult_teacher_identity();
  static const int kConsultTeacherIdentityFieldNumber = 8;
...
// optional uint32 consult_teacher_identity = 8;
inline bool StudentStat::has_consult_teacher_identity() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void StudentStat::set_has_consult_teacher_identity() {
  _has_bits_[0] |= 0x00000080u;
}
inline void StudentStat::clear_has_consult_teacher_identity() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void StudentStat::clear_consult_teacher_identity() {
  consult_teacher_identity_ = 0u;
  clear_has_consult_teacher_identity();
}
inline ::google::protobuf::uint32 StudentStat::consult_teacher_identity() const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.StudentStat.consult_teacher_identity)
  return consult_teacher_identity_;
}
inline void StudentStat::set_consult_teacher_identity(::google::protobuf::uint32 value) {
  set_has_consult_teacher_identity();
  consult_teacher_identity_ = value;
  // @@protoc_insertion_point(field_set:IM.BaseDefine.StudentStat.consult_teacher_identity)
}
...
// optional uint32 robot_type = 8;
inline bool ConsultTimeout::has_robot_type() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ConsultTimeout::set_has_robot_type() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ConsultTimeout::clear_has_robot_type() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ConsultTimeout::clear_robot_type() {
  robot_type_ = 0u;
  clear_has_robot_type();
}
inline ::google::protobuf::uint32 ConsultTimeout::robot_type() const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.ConsultTimeout.robot_type)
  return robot_type_;
}
inline void ConsultTimeout::set_robot_type(::google::protobuf::uint32 value) {
  set_has_robot_type();
  robot_type_ = value;
  // @@protoc_insertion_point(field_set:IM.BaseDefine.ConsultTimeout.robot_type)
}

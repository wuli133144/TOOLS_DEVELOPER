...
void protobuf_ShutdownFile_IM_2eMessage_2eproto() {
  ...
  delete IMMsgSocialData::default_instance_;
  delete IMMsgFromSystem::default_instance_;
  delete IMMsgFromSystem2App::default_instance_;
}
...
void protobuf_AddDesc_IM_2eMessage_2eproto() {
  ...
  IMMsgSocialData::default_instance_ = new IMMsgSocialData();
  IMMsgFromSystem::default_instance_ = new IMMsgFromSystem();
  IMMsgFromSystem2App::default_instance_ = new IMMsgFromSystem2App();
  ...
  IMMsgSocialData::default_instance_->InitAsDefaultInstance();
  IMMsgFromSystem::default_instance_->InitAsDefaultInstance();
  IMMsgFromSystem2App::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int IMMsgSocialData::kImIdFieldNumber;
const int IMMsgSocialData::kDataFieldNumber;
#endif  // !_MSC_VER

IMMsgSocialData::IMMsgSocialData()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Message.IMMsgSocialData)
}

void IMMsgSocialData::InitAsDefaultInstance() {
}

IMMsgSocialData::IMMsgSocialData(const IMMsgSocialData& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Message.IMMsgSocialData)
}

void IMMsgSocialData::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  im_id_ = 0u;
...
IMMsgSocialData::~IMMsgSocialData() {
  // @@protoc_insertion_point(destructor:IM.Message.IMMsgSocialData)
  SharedDtor();
}

void IMMsgSocialData::SharedDtor() {
...
void IMMsgSocialData::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMMsgSocialData& IMMsgSocialData::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eMessage_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eMessage_2eproto();
...
IMMsgSocialData* IMMsgSocialData::default_instance_ = NULL;

IMMsgSocialData* IMMsgSocialData::New() const {
  return new IMMsgSocialData;
}

void IMMsgSocialData::Clear() {
  if (_has_bits_[0 / 32] & 3) {
    im_id_ = 0u;
    if (has_data()) {
      if (data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
bool IMMsgSocialData::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Message.IMMsgSocialData)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Message.IMMsgSocialData)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Message.IMMsgSocialData)
  return false;
#undef DO_
}

void IMMsgSocialData::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Message.IMMsgSocialData)
  // required uint32 im_id = 1;
  if (has_im_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->im_id(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Message.IMMsgSocialData)
}

int IMMsgSocialData::ByteSize() const {
  int total_size = 0;
...
void IMMsgSocialData::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMMsgSocialData*>(&from));
}

void IMMsgSocialData::MergeFrom(const IMMsgSocialData& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_im_id()) {
      set_im_id(from.im_id());
    }
    if (from.has_data()) {
      set_data(from.data());
    }
...
void IMMsgSocialData::CopyFrom(const IMMsgSocialData& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMMsgSocialData::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void IMMsgSocialData::Swap(IMMsgSocialData* other) {
  if (other != this) {
    std::swap(im_id_, other->im_id_);
...
::std::string IMMsgSocialData::GetTypeName() const {
  return "IM.Message.IMMsgSocialData";
}
...
#ifndef _MSC_VER
const int IMMsgFromSystem::kSocialDataListFieldNumber;
#endif  // !_MSC_VER

IMMsgFromSystem::IMMsgFromSystem()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Message.IMMsgFromSystem)
}

void IMMsgFromSystem::InitAsDefaultInstance() {
}

IMMsgFromSystem::IMMsgFromSystem(const IMMsgFromSystem& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Message.IMMsgFromSystem)
}

void IMMsgFromSystem::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

IMMsgFromSystem::~IMMsgFromSystem() {
  // @@protoc_insertion_point(destructor:IM.Message.IMMsgFromSystem)
  SharedDtor();
}

void IMMsgFromSystem::SharedDtor() {
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
  #else
  if (this != default_instance_) {
...
void IMMsgFromSystem::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMMsgFromSystem& IMMsgFromSystem::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eMessage_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eMessage_2eproto();
...
IMMsgFromSystem* IMMsgFromSystem::default_instance_ = NULL;

IMMsgFromSystem* IMMsgFromSystem::New() const {
  return new IMMsgFromSystem;
}

void IMMsgFromSystem::Clear() {
  social_data_list_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->clear();
}

bool IMMsgFromSystem::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Message.IMMsgFromSystem)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (tag == 10) {
         parse_social_data_list:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_social_data_list()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(10)) goto parse_social_data_list;
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:IM.Message.IMMsgFromSystem)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Message.IMMsgFromSystem)
  return false;
#undef DO_
}

void IMMsgFromSystem::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Message.IMMsgFromSystem)
  // repeated .IM.Message.IMMsgSocialData social_data_list = 1;
  for (int i = 0; i < this->social_data_list_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      1, this->social_data_list(i), output);
  }

  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Message.IMMsgFromSystem)
}

int IMMsgFromSystem::ByteSize() const {
  int total_size = 0;

  // repeated .IM.Message.IMMsgSocialData social_data_list = 1;
  total_size += 1 * this->social_data_list_size();
  for (int i = 0; i < this->social_data_list_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->social_data_list(i));
  }
...
void IMMsgFromSystem::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMMsgFromSystem*>(&from));
}

void IMMsgFromSystem::MergeFrom(const IMMsgFromSystem& from) {
  GOOGLE_CHECK_NE(&from, this);
  social_data_list_.MergeFrom(from.social_data_list_);
  mutable_unknown_fields()->append(from.unknown_fields());
}

void IMMsgFromSystem::CopyFrom(const IMMsgFromSystem& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMMsgFromSystem::IsInitialized() const {

  if (!::google::protobuf::internal::AllAreInitialized(this->social_data_list())) return false;
  return true;
}

void IMMsgFromSystem::Swap(IMMsgFromSystem* other) {
  if (other != this) {
    social_data_list_.Swap(&other->social_data_list_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.swap(other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
::std::string IMMsgFromSystem::GetTypeName() const {
  return "IM.Message.IMMsgFromSystem";
}
...
#ifndef _MSC_VER
const int IMMsgFromSystem2App::kImIdFieldNumber;
const int IMMsgFromSystem2App::kDataFieldNumber;
#endif  // !_MSC_VER

IMMsgFromSystem2App::IMMsgFromSystem2App()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Message.IMMsgFromSystem2App)
}

void IMMsgFromSystem2App::InitAsDefaultInstance() {
}

IMMsgFromSystem2App::IMMsgFromSystem2App(const IMMsgFromSystem2App& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Message.IMMsgFromSystem2App)
}

void IMMsgFromSystem2App::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  im_id_ = 0u;
  data_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
IMMsgFromSystem2App::~IMMsgFromSystem2App() {
  // @@protoc_insertion_point(destructor:IM.Message.IMMsgFromSystem2App)
  SharedDtor();
}

void IMMsgFromSystem2App::SharedDtor() {
  if (data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete data_;
  }
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
void IMMsgFromSystem2App::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMMsgFromSystem2App& IMMsgFromSystem2App::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eMessage_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eMessage_2eproto();
...
IMMsgFromSystem2App* IMMsgFromSystem2App::default_instance_ = NULL;

IMMsgFromSystem2App* IMMsgFromSystem2App::New() const {
  return new IMMsgFromSystem2App;
}

void IMMsgFromSystem2App::Clear() {
  if (_has_bits_[0 / 32] & 3) {
    im_id_ = 0u;
    if (has_data()) {
      if (data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
bool IMMsgFromSystem2App::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Message.IMMsgFromSystem2App)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Message.IMMsgFromSystem2App)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Message.IMMsgFromSystem2App)
  return false;
#undef DO_
}

void IMMsgFromSystem2App::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Message.IMMsgFromSystem2App)
  // required uint32 im_id = 1;
  if (has_im_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->im_id(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Message.IMMsgFromSystem2App)
}

int IMMsgFromSystem2App::ByteSize() const {
  int total_size = 0;
...
void IMMsgFromSystem2App::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMMsgFromSystem2App*>(&from));
}

void IMMsgFromSystem2App::MergeFrom(const IMMsgFromSystem2App& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_im_id()) {
      set_im_id(from.im_id());
...
void IMMsgFromSystem2App::CopyFrom(const IMMsgFromSystem2App& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMMsgFromSystem2App::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  return true;
}

void IMMsgFromSystem2App::Swap(IMMsgFromSystem2App* other) {
  if (other != this) {
    std::swap(im_id_, other->im_id_);
    std::swap(data_, other->data_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
...
::std::string IMMsgFromSystem2App::GetTypeName() const {
  return "IM.Message.IMMsgFromSystem2App";
}

...
const int StudentStat::kConsultTeacherIdentityFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_consult_teacher_identity;
        break;
      }
...
void StudentStat::SerializeWithCachedSizes(
  ...
  if (has_consult_teacher_identity()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(8, this->consult_teacher_identity(), output);
  }
...
const int ConsultTimeout::kRobotTypeFieldNumber;
#endif  // !_MSC_VER

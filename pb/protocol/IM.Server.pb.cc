...
void protobuf_ShutdownFile_IM_2eServer_2eproto() {
  ...
  delete IMSystemLoginStatusNotify::default_instance_;
}
...
void protobuf_AddDesc_IM_2eServer_2eproto() {
  ...
  IMSystemLoginStatusNotify::default_instance_ = new IMSystemLoginStatusNotify();
  ...
  IMSystemLoginStatusNotify::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int IMSystemLoginStatusNotify::kSystemLoginStatusFieldNumber;
const int IMSystemLoginStatusNotify::kAttachDataFieldNumber;
#endif  // !_MSC_VER

IMSystemLoginStatusNotify::IMSystemLoginStatusNotify()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMSystemLoginStatusNotify)
}

void IMSystemLoginStatusNotify::InitAsDefaultInstance() {
}

IMSystemLoginStatusNotify::IMSystemLoginStatusNotify(const IMSystemLoginStatusNotify& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMSystemLoginStatusNotify)
}

void IMSystemLoginStatusNotify::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
...
IMSystemLoginStatusNotify::~IMSystemLoginStatusNotify() {
  // @@protoc_insertion_point(destructor:IM.Server.IMSystemLoginStatusNotify)
  SharedDtor();
}

void IMSystemLoginStatusNotify::SharedDtor() {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete attach_data_;
  }
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
void IMSystemLoginStatusNotify::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMSystemLoginStatusNotify& IMSystemLoginStatusNotify::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMSystemLoginStatusNotify* IMSystemLoginStatusNotify::default_instance_ = NULL;

IMSystemLoginStatusNotify* IMSystemLoginStatusNotify::New() const {
  return new IMSystemLoginStatusNotify;
}

void IMSystemLoginStatusNotify::Clear() {
...
bool IMSystemLoginStatusNotify::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMSystemLoginStatusNotify)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(16383);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMSystemLoginStatusNotify)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMSystemLoginStatusNotify)
  return false;
#undef DO_
}

void IMSystemLoginStatusNotify::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMSystemLoginStatusNotify)
  // required uint32 system_login_status = 1;
  if (has_system_login_status()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->system_login_status(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMSystemLoginStatusNotify)
}

int IMSystemLoginStatusNotify::ByteSize() const {
  int total_size = 0;
...
void IMSystemLoginStatusNotify::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMSystemLoginStatusNotify*>(&from));
}

void IMSystemLoginStatusNotify::MergeFrom(const IMSystemLoginStatusNotify& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_system_login_status()) {
      set_system_login_status(from.system_login_status());
    }
    if (from.has_attach_data()) {
      set_attach_data(from.attach_data());
    }
...
void IMSystemLoginStatusNotify::CopyFrom(const IMSystemLoginStatusNotify& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMSystemLoginStatusNotify::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void IMSystemLoginStatusNotify::Swap(IMSystemLoginStatusNotify* other) {
  if (other != this) {
    std::swap(system_login_status_, other->system_login_status_);
    std::swap(attach_data_, other->attach_data_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.swap(other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
...
::std::string IMSystemLoginStatusNotify::GetTypeName() const {
  return "IM.Server.IMSystemLoginStatusNotify";
}

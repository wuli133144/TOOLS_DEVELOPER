...
class IMSystemLoginStatusNotify;
...
class IMSystemLoginStatusNotify : public ::google::protobuf::MessageLite {
 public:
  IMSystemLoginStatusNotify();
  virtual ~IMSystemLoginStatusNotify();

  IMSystemLoginStatusNotify(const IMSystemLoginStatusNotify& from);

  inline IMSystemLoginStatusNotify& operator=(const IMSystemLoginStatusNotify& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const IMSystemLoginStatusNotify& default_instance();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const IMSystemLoginStatusNotify* internal_default_instance() {
    return default_instance_;
  }
  #endif

  void Swap(IMSystemLoginStatusNotify* other);

  // implements Message ----------------------------------------------

  IMSystemLoginStatusNotify* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const IMSystemLoginStatusNotify& from);
  void MergeFrom(const IMSystemLoginStatusNotify& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // required uint32 system_login_status = 1;
  inline bool has_system_login_status() const;
  inline void clear_system_login_status();
  static const int kSystemLoginStatusFieldNumber = 1;
  inline ::google::protobuf::uint32 system_login_status() const;
  inline void set_system_login_status(::google::protobuf::uint32 value);
  ...
  // @@protoc_insertion_point(class_scope:IM.Server.IMSystemLoginStatusNotify)
 private:
  inline void set_has_system_login_status();
  inline void clear_has_system_login_status();
  inline void set_has_attach_data();
  inline void clear_has_attach_data();
  ...
  mutable int _cached_size_;
  ::std::string* attach_data_;
  ::google::protobuf::uint32 system_login_status_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_IM_2eServer_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_IM_2eServer_2eproto();
  ...
  void InitAsDefaultInstance();
  static IMSystemLoginStatusNotify* default_instance_;
};
// ===================================================================
...
// required uint32 system_login_status = 1;
inline bool IMSystemLoginStatusNotify::has_system_login_status() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void IMSystemLoginStatusNotify::set_has_system_login_status() {
  _has_bits_[0] |= 0x00000001u;
}
inline void IMSystemLoginStatusNotify::clear_has_system_login_status() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void IMSystemLoginStatusNotify::clear_system_login_status() {
  system_login_status_ = 0u;
  clear_has_system_login_status();
}
inline ::google::protobuf::uint32 IMSystemLoginStatusNotify::system_login_status() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMSystemLoginStatusNotify.system_login_status)
  return system_login_status_;
}
inline void IMSystemLoginStatusNotify::set_system_login_status(::google::protobuf::uint32 value) {
  set_has_system_login_status();
  system_login_status_ = value;
  // @@protoc_insertion_point(field_set:IM.Server.IMSystemLoginStatusNotify.system_login_status)
}

// optional bytes attach_data = 20;
inline bool IMSystemLoginStatusNotify::has_attach_data() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void IMSystemLoginStatusNotify::set_has_attach_data() {
  _has_bits_[0] |= 0x00000002u;
}
inline void IMSystemLoginStatusNotify::clear_has_attach_data() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void IMSystemLoginStatusNotify::clear_attach_data() {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_->clear();
  }
  clear_has_attach_data();
}
inline const ::std::string& IMSystemLoginStatusNotify::attach_data() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMSystemLoginStatusNotify.attach_data)
  return *attach_data_;
}
inline void IMSystemLoginStatusNotify::set_attach_data(const ::std::string& value) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMSystemLoginStatusNotify.attach_data)
}
inline void IMSystemLoginStatusNotify::set_attach_data(const char* value) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMSystemLoginStatusNotify.attach_data)
}
inline void IMSystemLoginStatusNotify::set_attach_data(const void* value, size_t size) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMSystemLoginStatusNotify.attach_data)
}
inline ::std::string* IMSystemLoginStatusNotify::mutable_attach_data() {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMSystemLoginStatusNotify.attach_data)
  return attach_data_;
}
inline ::std::string* IMSystemLoginStatusNotify::release_attach_data() {
  clear_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMSystemLoginStatusNotify::set_allocated_attach_data(::std::string* attach_data) {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete attach_data_;
  }
  if (attach_data) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Server.IMSystemLoginStatusNotify.attach_data)
}
